        ...
        <div className=' min-h-screen overflow-hidden bg-[#101010] text-white'>
            <div className='flex justify-center flex-wrap content-center w-full mt-10'>
                ...
                <div className='flex flex-col h-30  flex-wrap '>
                    <div className='font-clash font-[600] text-center md:text-4xl uppercase' >Creative. </div>
                    <div className='font-clash font-[600] text-center md:text-4xl uppercase'>Dedicated. </div>
                    <div className='font-clash font-[600] text-center md:text-4xl uppercase text-[#FD3EB5]'>Experienced. </div>
                </div>
                <Image src={diamond} className='md:h-30 object-cover md:w-30 h-15 w-15 ' alt='' />
            </div>
