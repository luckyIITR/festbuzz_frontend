  ...
  return (
    <form className="w-full max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={e => { e.preventDefault(); handleNext(); }}>
      ...
      <div className="flex flex-col gap-2 col-span-1 md:col-span-2">
        <label className="text-white font-urbanist font-[700]  mb-1">Fest Mode*</label>
        <div className="flex gap-4">
          <button type="button" className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold shadow-md transition-all duration-300 bg-[#252525] ${form.visibility === 'public' ? 'text-[white]' : 'text-[#565656]'} `} onClick={() => setForm(f => ({ ...f, visibility: 'public' }))}>
            ...
            <div className="font-urbanist font-[600]">Online</div>
          </button>
          <button type="button" className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold shadow-md transition-all duration-300 bg-[#252525]  ${form.visibility === 'public' ? 'text-[#565656]' : 'text-[white]'} `} onClick={() => setForm(f => ({ ...f, visibility: 'private' }))}>
            ...
            <div className="font-urbanist font-[600]">Offline</div>
          </button>
        </div>
      </div>
      {/* Rulebook link */}
      <div className="flex flex-col gap-2">
        <label className="text-white font-urbanist font-[700] mb-1">Rulebook link*</label>
        <input name="rulebook" value={form.rulebook || ''} onChange={handleInput} className="bg-[#252525] backdrop-blur-md rounded-xl px-4 py-3 font-urbanist font-[600] text-white focus:outline-none shadow-md focus:ring-2 focus:ring-pink-400 transition-all placeholder:text-[#565656]" placeholder="URL" />
      </div>
      {/* Instagram link */}
      <div className="flex flex-col gap-2">
        <label className="text-white font-urbanist font-[700] mb-1">Instagram link</label>
        <input name="instagram" value={form.instagram || ''} onChange={handleInput} className="bg-[#252525] backdrop-blur-md rounded-xl px-4 py-3 font-urbanist font-[600] text-white focus:outline-none shadow-md focus:ring-2 focus:ring-blue-400 transition-all placeholder:text-[#565656]" placeholder="URL" />
      </div>
      {/* About Fest */}
      <div className="flex flex-col gap-2 md:col-span-2">
        <label className="text-white font-urbanist font-[700] mb-1">About Fest*</label>
        <div className="bg-[#252525] backdrop-blur-md rounded-xl shadow-md">
          ...
          <textarea name="about" value={form.about || ''} onChange={handleTextArea} className="w-full bg-transparent px-4 py-3 font-urbanist font-[600] text-white min-h-[120px] focus:outline-none resize-none placeholder:text-[#565656]" placeholder="Describe about your event make sure add all details including eligibility and others" />
        </div>
      </div>
      {/* Website link */}
      <div className="flex flex-col gap-2">
        <label className="text-white font-urbanist font-[700] mb-1">Website link</label>
        <input name="website" value={form.website || ''} onChange={handleInput} className="bg-[#252525] backdrop-blur-md rounded-xl px-4 py-3 font-urbanist font-[600] text-white focus:outline-none shadow-md focus:ring-2 focus:ring-blue-400 transition-all placeholder:text-[#565656]" placeholder="URL" />
      </div>
      {/* Contact number */}
      <div className="flex flex-col gap-2">
        <label className="text-white font-urbanist font-[700] mb-1">Contact number</label>
        <input name="contact" value={form.contact || ''} onChange={handleInput} className={`bg-[#252525] backdrop-blur-md rounded-xl px-4 py-3 font-urbanist font-[600] focus:outline-none shadow-md focus:ring-2 focus:ring-pink-400 transition-all placeholder:text-[#565656] `} placeholder="Contact number" />
      </div>
      {/* E-mail */}
      <div className="flex flex-col gap-2 md:col-span-2">
        <label className="text-white font-urbanist font-[700] mb-1">E-mail</label>
        <input name="email" value={form.email || ''} onChange={handleInput} className={`bg-[#252525] backdrop-blur-md rounded-xl px-4 py-3 font-urbanist font-[600] focus:outline-none w-full shadow-md focus:ring-2 focus:ring-blue-400 transition-all placeholder:text-[#565656] `} placeholder="E-mail" />
      </div>
