  ...
  return (
    <form className="w-full max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={e => { e.preventDefault(); handleNext(); }}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <label className="bg-[#252525] backdrop-blur-md rounded-2xl flex flex-col items-center justify-center h-28 border-2 border-dashed border-pink-400 cursor-pointer text-pink-300 shadow-lg hover:bg-white/20 transition-all duration-300">
          <input type="file" accept="image/*" className="hidden" onChange={handleLogo} />
          <div className="flex content-center flex-wrap gap-1 items-center">
            <svg width="38" height="32" viewBox="0 0 38 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="font-medium">{form.logo ? form.logo.name : "Click here or drag & drop"}</span>
          </div>
        </label>
      </div>
      {/* Upload photos */}
      <div className="flex flex-col gap-2">
        ...
        <label className="bg-[#252525]backdrop-blur-md rounded-2xl flex flex-col items-center justify-center h-28 border-2 border-dashed border-blue-400 cursor-pointer text-blue-300 shadow-lg hover:bg-white/20 transition-all duration-300">
      ...
      <div className="flex flex-col gap-2">
        ...
        <select name="festType" value={form.festType} onChange={handleInput} className="bg-white/10 backdrop-blur-md rounded-xl px-4 py-3 text-white focus:outline-none shadow-md focus:ring-2 focus:ring-pink-400 transition-all">
          <option className="bg-[#565656]" value="">Select type</option>
          <option className="bg-[#565656]" value="Thomso">Thomso</option>
          <option className="bg-[#565656]" value="Cultural">Cultural</option>
          <option className="bg-[#565656]" value="Technical">Technical</option>
          <option className="bg-[#565656]" value="Sports">Sports</option>
        </select>
      </div>
      {/* Fest name */}
      <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <select name="venue" value={form.venue} onChange={handleInput} className="bg-white/10 backdrop-blur-md rounded-xl px-4 py-3 text-white focus:outline-none shadow-md focus:ring-2 focus:ring-blue-400 transition-all">
          <option className="bg-[#565656]" value="">Venue</option>
          <option className="bg-[#565656]" value="IIT Roorkee">IIT Roorkee</option>
          <option className="bg-[#565656]" value="IIT Delhi">IIT Delhi</option>
        </select>
      </div>
      {/* College */}
      <div className="flex flex-col gap-2">
