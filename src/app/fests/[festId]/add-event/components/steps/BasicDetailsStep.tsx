...
export default function BasicDetailsStep({ visibility, setVisibility }: BasicDetailsStepProps) {
  return (
    <form className="w-full max-w-full lg:w-6/12 xl:w-6/12 md:w-8/12 sm:w-full flex flex-col gap-4 md:gap-6 min-h-[560px] px-4 sm:px-6 md:px-0">
      
      {/* Event Name */}
      <div>
        <label className="block font-urbanist font-[600] text-[18px] sm:text-[20px] mb-2 text-white">
          Event name
        </label>
        <input 
          type="text" 
      ...
      <div>
        ...
        <div className="relative">
          <select className="appearance-none w-full bg-[#252525] font-urbanist rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 pr-8 sm:pr-10 text-white focus:outline-none focus:ring-2 focus:ring-[#E6FF4C] text-sm sm:text-base">
            <option className="text-[#565656] bg-[#252525]" value="">Select event type</option>
            <option className="text-white bg-[#252525]" value="workshop">Workshop</option>
            <option className="text-white bg-[#252525]" value="competition">Competition</option>
            <option className="text-white bg-[#252525]" value="seminar">Seminar</option>
            <option className="text-white bg-[#252525]" value="other">Other</option>
          </select>
          <div className="pointer-events-none text-[8px] sm:text-[10px] absolute inset-y-0 right-3 sm:right-4 flex items-center text-white">
            ▼
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          <button
            type="button"
            className={`flex-1 flex items-center font-urbanist text-[14px] sm:text-[16px] justify-center gap-2 rounded-lg py-2.5 sm:py-3 px-3 font-[500] border-2 transition-colors min-h-[48px] ${
              visibility === 'open' 
                ? 'bg-[#232323] border-[#E6FF4C] text-[#E6FF4C]' 
                : 'bg-[#232323] border-[#232323] text-white hover:border-[#404040]'
            }`}
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
        <div className="flex-1 min-w-0">
          ...
          <input 
            type="date" 
            className="w-full bg-[#252525] rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#E6FF4C] text-sm sm:text-base
