            ...
            <div className="flex-1 flex  flex-row">
                ...
                <main className="flex-1 flex flex-col p-10 relative">
                    <form className=" w-6/12 flex flex-col gap-6">
                        <div>
                            <label className="block font-urbanist font-[600]  text-[20px] mb-2">Ticket name*</label>
                            <input type="text" placeholder="Early bird/RSVP/VIP" className="w-full bg-[#252525] rounded-lg px-4 py-3 font-urbanist font-[600] text-white placeholder-[#565656] focus:outline-none focus:ring-2 focus:ring-[#E6FF4C]" />
                        </div>

                        <div>
                            <label className="block font-urbanist  font-[600] text-[20px] mb-2">Fee Type*</label>
                            ...
                            <div>
                                <label className="block font-urbanist font-[600]  text-[20px] mb-2">Ticket Pricing*</label>
                                <input type="number" placeholder="INR" className="w-full bg-[#252525] rounded-lg px-4 py-3 font-urbanist font-[600] text-white placeholder-[#B7B7B7] focus:outline-none focus:ring-2 focus:ring-[#E6FF4C]" />
                            </div>
                        </div>
                        <div className='flex gap-8'>
                            <div className="flex flex-col gap-2">
                                <label className="text-white font-urbanist font-[700] text-[20px] mb-1">Tickets available from*</label>
                                <div className="flex gap-6">
                                    <input type="date" name="ticketStartDate" className="bg-[#252525] backdrop-blur-md rounded-xl px-8 py-3 text-white focus:outline-none w-50 shadow-md focus:ring-2 focus:ring-blue-400 transition-all placeholder:text-gray-400" placeholder="Start Date" />
                                    <input type="time" name="ticketStartTime" className="bg-[#252525] backdrop-blur-md rounded-xl px-8 py-3 text-white focus:outline-none w-50 shadow-md focus:ring-2 focus:ring-pink-400 transition-all placeholder:text-gray-400" placeholder="End Clock" />
                                </div>
                            </div>
                            {/* Tickets available till */}
                            <div className="flex flex-col gap-2">
                                <label className="text-white font-urbanist font-[700] text-[20px] mb-1">Tickets available till*</label>
                                <div className="flex gap-6">
                                    <input type="date" name="ticketStartDate" className="bg-[#252525] backdrop-blur-md rounded-xl px-8 py-3 text-white focus:outline-none w-50 shadow-md focus:ring-2 focus:ring-blue-400 transition-all placeholder:text-gray-400" placeholder="Start Date" />
                                    <input type="time" name="ticketStartTime" className="bg-[#252525] backdrop-blur-md rounded-xl px-8 py-3 text-white focus:outline-none w-50 shadow-md focus:ring-2 focus:ring-pink-400 transition-all placeholder:text-gray-400" placeholder="End Clock" />
                                </div>
