  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative w-full h-[320px] md:h-[300px] flex items-end overflow-hidden">
        <Image src={heroImage} alt="Fest Hero" width={1500} height={400} className="absolute inset-0 w-full h-full object-cover object-center opacity-80" />
        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-end justify-between px-6 md:px-16 pb-8">
          <div className="flex items-center gap-6">
            <Image src={festLogo} alt="Fest Logo" width={80} height={80} className="w-20 h-20 rounded-full border-4 border-yellow-400 bg-black object-contain" />
            <div>
              <h1 className="text-2xl md:text-4xl font-extrabold text-yellow-300 mb-1">MUSIC FESTIVAL</h1>
              <div className="text-gray-200 text-sm mb-1">Organized by - <span className="font-semibold">IIT Roorkee</span></div>
