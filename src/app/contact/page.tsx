...
const page: React.FC = () => {
    ...
    const handlechange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (name === "email") {
            ...
            if ((window as any).emailVerificationTimeout) {
                clearTimeout((window as any).emailVerificationTimeout);
            }
            
            (window as any).emailVerificationTimeout = setTimeout(async () => {
    ...
    return (
        <div className='min-h-screen p-6'>
            ...
            <form onSubmit={handleSubmit} className='md:w-120 w-85 mb-40 '>
                <input 
                    type="text" 
                    name="name"
                    value={form.name}
