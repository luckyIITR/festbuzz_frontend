        ...
        <div className="flex flex-col gap-0 mt-6">
          ...
          <div className="relative flex flex-col md:flex-row items-stretch bg-lime-200 min-h-[260px] overflow-hidden rounded-2xl mb-6 px-4 md:px-8">
            ...
            <div className="relative flex-1 min-h-[180px] md:min-h-0">
              <Image src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=600&q=80" alt="Team" width={600} height={160} className="w-full h-full object-cover object-center" />
              {/* Decorative squares */}
          ...
          <div className="relative flex flex-col md:flex-row items-stretch bg-pink-400 min-h-[260px] overflow-hidden rounded-2xl mb-6 px-4 md:px-8">
            <div className="relative flex-1 min-h-[180px] md:min-h-0 order-2 md:order-1">
              <Image src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=600&q=80" alt="Concert" width={600} height={160} className="w-full h-full object-cover object-center" />
              {/* Decorative squares */}
